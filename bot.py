availabilityDomains = ["drGJ:AP-SINGAPORE-1-AD-1"]
displayName = 'instance-20230328-0348'
compartmentId = 'ocid1.tenancy.oc1..aaaaaaaadeiesbvzak27j6gh3u3roqhojigzseppys2rlv4wxdxwhdyvedua'
imageId = "ocid1.image.oc1.ap-singapore-1.aaaaaaaapgcl7ndb6epgmhbv2robcgmqlx2vnw5y7kjeejkt2fyioalzodjq"
subnetId = 'ocid1.subnet.oc1.ap-singapore-1.aaaaaaaah76kw7nfyzzasubokdgntkpay4s6vzdsp3eszc4qcvixd5ch66yq'
ssh_authorized_keys = "ssh-rsa  ssh-key-2023-03-28"
...
while True:
    ...
    source_details=(source_type="oci.core.models.InstanceSourceViaImageDetails(source_type="image",image_id=imageId)
,
